...
export const genesisLetterProfiles: Record<GenesisLetterId, GenesisLetterDeepProfile> = {
  aleph: {
    ...
    genesisRole: "Aleph verbindet Elohim, et, eretz, amar und or: Gott, Erde, Zeichen, Sprechen und Licht.",
    roomIds: ["licht"],
...
export const genesisWordMovements: Record<string, GenesisWordMovement> = {
  ...
  haja: {
    wordId: "haja",
    movement: "Hauch, Impuls und Hauch halten Sein und Werden als stille Schwelle zusammen.",
    letters: [
      { letterId: "he", role: "offener Hauch des Daseins" },
      { letterId: "jod", role: "Wirkimpuls im Werden" },
      { letterId: "he", role: "zweiter Hauch: Erscheinung bleibt offen" },
    ],
  },
  al: {
    wordId: "al",
  ...
  wajehi: {
    wordId: "wajehi",
    movement: "Vav verbindet, Jod setzt den Impuls, He oeffnet, Jod bestaetigt: der Ruf wird Ereignis.",
    letters: [
      { letterId: "vav", role: "Fortgang vom Ruf zum Geschehen" },
      { letterId: "jod", role: "Wirkimpuls" },
      { letterId: "he", role: "Fenster des Erscheinens" },
      { letterId: "jod", role: "bestaetigtes Werden" },
    ],
  },
  or: {
    wordId: "or",
...
export const genesisVerseLetterLayers: Record<GenesisVerseLetterLayer["verseId"], GenesisVerseLetterLayer> = {
  ...
  "genesis-1-2": {
    ...
    wordIds: ["erez", "haja", "tohu", "bohu", "choschech", "al", "pnei", "tehom", "ruach", "rachaf", "majim"],
  ...
  "genesis-1-3": {
    ...
    wordIds: ["amar", "elohim", "jehi", "or", "wajehi"],
