...
export const roomTransitions = [
  ...
  },
  {
    ...
    shortMeaning: "Nicht alles wird sofort erfüllt.",
    prepares: ["Prüfung", "Leere", "Hören"],
    keywords: ["Glut", "Weite", "Prüfung", "Leere", "Hören"],
  },
  {
    sourceRoom: "wueste",
    targetRoom: "brot",
    title: "Im Mangel erscheint die Gabe",
    shortMeaning: "Was trägt, entsteht oft erst in der Bedürftigkeit.",
