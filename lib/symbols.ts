...
const WATER_SCRIPTURE_REFERENCES: SymbolScriptureReference[] = [
  {
    ...
    symbolicRole: 'Im SYMBOLRAUM kann dies als Urtiefe, Anfangsraum und noch ungeordnete Schoepfung gelesen werden.',
  ...
  },
  {
    ...
    symbolicRole: 'Symbolisch erscheint Wasser als Grenze, die zum Uebergang in eine neue Ordnung werden kann.',
