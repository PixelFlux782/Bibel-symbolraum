...
function scriptureEntry(referenceId: "genesis-1" | "genesis-1-1" | "genesis-1-2" | "genesis-1-3" | "exodus-14"): CodexEntry {
  ...
  const base = {
    ...
    "genesis-1-1": {
      ...
      summary:
        "Genesis 1:1 setzt den ersten Horizont: Im Anfang schafft Gott Himmel und Erde. Die Symbole Anfang, Schöpfung, Himmel und Erde markieren die Grundspannung von oben und unten, Ursprung und werdender Welt. Für das Symbolnetz ist der Vers der ruhige Startpunkt, von dem aus jede weitere Ordnung erst Sinn und Richtung bekommt.",
      meaningFields: ["birth", "life", "hiddenness"] satisfies CodexEntry["meaningFields"],
      relations: [
        { targetId: "anfang", type: "anchors-scripture", label: "Der Anfang als erster Ort der Erzählung.", source: "scripture-reference" },
        { targetId: "schoepfung", type: "anchors-scripture", label: "Schöpfung als Hervortreten von Welt und Ordnung.", source: "scripture-reference" },
    ...
    "genesis-1-2": {
      ...
      summary:
        "Genesis 1,2 bewahrt den Anfang vor der Ordnung: Tiefe, Wasser und Finsternis sind noch ungeformte Möglichkeit. Über den Wassern schwebt der Geist. Der Vers steht im Codex als stille Schwelle, an der Ursprung noch nicht Gestalt ist und doch schon getragen wird.",
      ...
      relations: [
        ...
        { targetId: "geist", type: "anchors-scripture", label: "Geist als bewegte Gegenwart über den Wassern.", source: "scripture-reference" },
    ...
    "genesis-1-3": {
      ...
      summary:
        "Genesis 1:3 lässt aus der Tiefe eine erste lesbare Gestalt hervortreten: Gott spricht, und Licht wird. Wort, Licht, Offenbarung und Aleph verbinden sich zu einem Motiv von Sichtbarkeit, Erkenntnis und Orientierung. Im Symbolnetz ist dieser Vers die Schwelle, an der das Verborgene nicht erklärt, sondern sichtbar gerufen wird.",
      meaningFields: biblicalMeaningFields(referenceId),
      relations: [
        { targetId: "or", type: "anchors-scripture", label: "Licht als erstes Sichtbarwerden der Schöpfung.", source: "meaning-graph" },
        { targetId: "davar", type: "anchors-scripture", label: "Das gesprochene Wort eröffnet Ordnung und Richtung.", source: "meaning-graph" },
    ...
    "exodus-14": {
      ...
      summary:
        "Exodus 14 liest das Meer als Schwelle. Wasser steht zwischen Knechtschaft und offenem Weg, zwischen Tiefe und Rettung. Der Durchzug erklärt die Tiefe nicht weg; er macht sie zum Ort, an dem eine Spur in neue Freiheit sichtbar wird.",
      ...
      relations: [
        ...
        { targetId: "midbar", type: "continues-journey", label: "Hinter dem Meer beginnt der offene Weg durch die Wüste.", source: "scripture-reference" },
        { targetId: "offenbarung", type: "shares-meaning", label: "Im Durchzug wird Rettung als sichtbarer Weg lesbar.", source: "meaning-graph" },
        { targetId: "tehom", type: "shares-meaning", label: "Die Tiefe bleibt gegenwärtig und wird doch begehbare Schwelle.", source: "meaning-graph" },
...
const seededCodexRegistry = [
  ...
  }),
  {
    ...
    relations: uniqueRelations([
      ...
      { targetId: "genesis-1-2", type: "anchors-scripture", label: "Genesis 1,2: Die Ruach Gottes schwebte über den Wassern.", source: "scripture-reference" },
    ]),
    scriptureAnchors: [
