...
export const codexRegistry = [
  ...
  meaningEntry({
    ...
    relations: [
      { targetId: "wasser", type: "shares-meaning", label: "Wasser traegt den Uebergang als Grenze und Durchgang.", source: "symbol-network" },
      ...
      { targetId: "tiefe", type: "shares-meaning", label: "Die Tiefe bleibt im Uebergang nicht fern, sondern wird begehbare Schwelle.", source: "meaning-graph" },
      { targetId: "wueste", type: "continues-journey", label: "Hinter dem Wasser beginnt der offene Weg der Wueste.", source: "symbol-network" },
  ...
  meaningEntry({
    ...
    relations: [
      { targetId: "wasser", type: "shares-meaning", label: "Wasser bewahrt Geburt als Anfang, Tiefe und Neuwerden.", source: "symbol-network" },
  ...
  meaningEntry({
    ...
    relations: [
      { targetId: "wasser", type: "shares-meaning", label: "Wasser traegt Verborgenheit als bedeckende Tiefe.", source: "symbol-network" },
      { targetId: "tiefe", type: "shares-meaning", label: "Tiefe sammelt das Noch-nicht-Sichtbare vor der ersten Form.", source: "meaning-graph" },
