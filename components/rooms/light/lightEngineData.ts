...
export const lightEngineData: SymbolEngineData = {
  ...
  hebrew: {
    ...
    letters: [
      ...
      },
      {
        ...
        detail: "Resh schließt das Wort mit einer sichtbaren Ausrichtung: Licht wird wahrnehmbar und lesbar.",
      },
    ],
  },
  scenes: [
    ...
    },
    {
      ...
      text: "Gott sieht das Licht. Das Gute wird als Qualität erkannt.",
      meaning: "Genesis 1,4 bleibt knapp: Or führt zu Raah, und Tov erscheint als erkannte, lebensfähige Qualität.",
    },
    {
      id: "exodus-pillar",
  ...
  connections: [
    ...
    { id: "or-raah", label: "Or → Raah", relation: "Licht → Sehen", detail: "Licht macht nicht nur hell. Es macht sichtbar und führt in Wahrnehmung." },
    { id: "seeing", label: "Sehen", relation: "Wahrnehmung", detail: "Licht wird in Genesis 1,4 gesehen, bevor es gut genannt wird." },
    { id: "raah-tov", label: "Raah → Tov", relation: "Sehen → Gut", detail: "Was sichtbar wird, kann erkannt werden; das Gute erscheint als stimmige Qualität des Lebens." },
    { id: "goodness", label: "Gut", relation: "Güte", detail: "Tov bezeichnet die erkannte, lebensfähige Qualität des Lichts." },
    ...
    { id: "presence", label: "Gegenwart", relation: "Nähe", detail: "Licht macht eine tragende Gegenwart erfahrbar." },
  ...
  states: [
    ...
    },
    {
      ...
      text: "Amar ruft Or. Wajehi bestätigt das Geschehen. Licht überstrahlt die Tiefe nicht; es macht sichtbar, was erkannt werden kann.",
      ...
      reflection: { kicker: "Innere Erfahrung", question: "Was wird sichtbar, wenn Licht auf deine Tiefe fällt?" },
    },
    {
      ...
      text: "Was sichtbar wird, kann erkannt werden. Genesis 1,4 bleibt eine leise Folgeschwelle: Licht wird gesehen, und Gut erscheint als Qualität, die Leben trägt.",
      ...
      visual: {
        ...
        atmosphere: { id: "recognized-light", mood: "erkennend", motion: "klärend", light: "warme Lichtachse", density: 0.48 },
        veilOpacity: 0.54,
      },
      hebrewLetterIds: ["resh"],
      hebrewCodexLetterIds: ["resh"],
      hebrewMeaningFieldIds: ["or-visibility", "or-awareness", "or-life"],
      hebrewSummary: "Resh schließt Or als bewusste Sichtbarkeit: Das Licht tritt vor den Blick und bereitet Raah und Tov vor.",
      biblicalSceneIds: ["genesis-light-seen"],
      connectionIds: ["or-raah", "seeing", "raah-tov", "goodness", "awareness"],
      reflection: { kicker: "Innere Erfahrung", question: "Wo erkennst du etwas als gut, weil es Leben trägt?" },
    },
    {
      id: "light-on-the-way",
    ...
    },
    {
      ...
      visual: {
        ...
        atmosphere: { id: "inner-light", mood: "gegenwärtig", motion: "sammelnd", light: "weichgold", density: 0.38 },
        veilOpacity: 0.48,
      },
      hebrewLetterIds: ["aleph", "vav", "resh"],
